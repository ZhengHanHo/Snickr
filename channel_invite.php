...
if (isset($_GET['uname'])): //当用户点击invite按钮时重新加载页面
    ...
    <?php
            ...
            <div class="alert alert-danger alert-dismissable fade show">
                <button type="button" class="close" data-dismiss="alert">×</button>
                <strong>Fail!</strong> <?php echo "You've already invited user ".$invitedUserName?>
            </div>
        <?php
        endif;?>
    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-outline-success"
                                                    onclick="javascript:window.location.href='<?php echo "channel_invite.php?admin=".$adminID,"&cname=".$channelID,"&uname=".$username[$i],"&wname=".$workspaceID?>'"> invite
                                            </button>
                                        </td>
                                    </tr>
                                <?php endfor; ?>
